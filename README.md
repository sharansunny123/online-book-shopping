...
- User Login Credentials: (sharan/sharan)
...
insert into users values('sharan','sharan','sharan','Raj','Bihar','1236547089','sharan@gmail.com',2);
...
Step 1: Click On File > Import > Git > Projects From Git > Clone Uri > Paste The Repository Url as: ```https://github.com/sharansunny123/online-book-shopping.git```> Select master Branch > Next > Next > Finish.
...
Step 8: The default Username And Password For User Is "sharan" And "sharan"
